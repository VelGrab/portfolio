...
export default function Music() {
    const handleClickFolder = () => {
        if(document.getElementById('folderMusic').style.display === 'block'){
    ...
    <div>
      ...
      <div id='folderMusic' className={style.containerFolder}>
        <div className={style.containerLineSup}>
          <img className={style.folderImgInside} src={FolderMusic} alt="Folder Inside" />
        ...
        <ReactPlayer width='100%' height='100%' controls={true} url='https://www.youtube.com/watch?v=WibjzL3fF1o&list=RDCb5TOFmLJnM&index=27&ab_channel=Elderbrook' />
        </div>
      </div>
    </div>
  )
